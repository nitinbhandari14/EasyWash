...
/**
 * This class stores all date time utility functions.
 * 
 * @author CEBS
 *
 */
public final class DateTimeUtil {
	...
	/**
	 * This method is used to return the current system timestamp.
	 * 
	 * @return
	 */
	public static String returnSystemTimestamp() {
		return new SimpleDateFormat(EWConstants.MP_OMS_TIMESTAMP_FORMAT).format(Calendar.getInstance().getTime());
	}
	
	/**
	 * This method is used to return the current system date.
	 * 
	 * @return
	 */
	public static String returnSystemDate() {
		return new SimpleDateFormat(EWConstants.MP_OMS_DATE_FORMAT).format(Calendar.getInstance().getTime());
	}
	
	/**This method is used to return the current system timestamp in input format
	 * 
	 */
	public static String returnSystemTimestamp(String format) {
	 ...
	 *             for all others
	 */
	public static String formatOnlyDate(java.util.Date inputDate,
			String outputFormat) throws IllegalArgumentException, Exception {
		// Validate input date value
		if (inputDate == null) {
			throw new IllegalArgumentException("Input date cannot "
	...
	public static String convertToSystemTimeZone(String sDateInput)
	{
		...
		try {
			   ...
			   SimpleDateFormat dateformat = new SimpleDateFormat(EWConstants.PRICE_STERLING_TS_FORMAT);
	...
	public Object getSterlingCurrentTimes() throws IllegalArgumentException,
		...
		String strDateFormat = formatDate(currentDateTime,
				EWConstants.PRICE_STERLING_TS_FORMAT);
	...
	/*
	 * "2020-07-22 11:37:44.048" "yyyy-MM-dd HH:mm:ss"
	 */
	public static Long stringDateToEPOCHTimebased(String date,String format) throws ParseException
	{
	...
	public static String timeDiffFromCreateTSWRTCreateORModf(Date date) throws IllegalArgumentException, Exception
	{
		String dateC=convertDate(date);
		String dateM=dateC.substring(0, dateC.indexOf('T'));
		String dateP=getCurrentDateTime("yyyyMMdd");
		return String.valueOf(getDifferenceInDays(convertDate(dateM, "yyyyMMdd"), convertDate( dateP, "yyyyMMdd")));
		
		
	}
	public static String diffInDaysWithFormat(String date1,String date2) throws IllegalArgumentException, Exception
	{
		return String.valueOf(Integer.valueOf(date1)-Integer.valueOf(date2));
	 ...
	 * @return Unique Key based on the time
	 */
	public static String createInvoiceKey(String currentTime) {
		//String currentTime = getCurrentDateTime("yyyyMMddHHmmssSSS");
		Double randNumber = new Double(java.lang.Math.random() * 10000);
	
		currentTime=currentTime +"-"+ randNumber.intValue();
